...
| [Bryan Behrenshausen](https://github.com//semioticrobotic) | Gitlab | Bryan Behrenshausen manages open source projects for Gitlab, including GitLab for Open Source and GitLab Open Source Partners. That means he helps open source projects use GitLab to grow, succeed, and thrive. | Building community, open governance models, open documentation and knowledge-sharing practices | [November 2020](https://github.com/open-organization/governance/issues/11#issuecomment-677825484) |
...
| [Jos Groen](https://github.com/JosGroenNL) | HBRD | Jos Groen is a practicing open leader who experienced firsthand what it takes to transform conventional organizations into open ones. He considers himself a practitioner-expert who enjoys sharing his exepriences with others and specializes in helping leaders establish an mindset. | | [November 2020](https://github.com/open-organization/governance/issues/13#issuecomment-733757933) |
